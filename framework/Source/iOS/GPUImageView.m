...
/* BestPartners: Modify By BestPartners，这里是原方法，已注释，新方法中将self.bounds.size提取到主线程访问
- (void)recalculateViewGeometry;
{
    runSynchronouslyOnVideoProcessingQueue(^{
...
//BestPartners: Modify By BestPartners，这里是改动后方法，将self.bounds提取到主线程访问
- (void)recalculateViewGeometry;
{
    __block CGRect currentBounds;
    
    dispatch_async(dispatch_get_main_queue(), ^(void){
        //主要改动，self.bounds放到主线程中访问，后续使用currentBounds代替
